...
- Android package: `com.myfilm.app`
...
the website repository. The migrated asset was verified against the exact SHA-256 above, so existing
`com.myfilm.app` installations keep the same signing identity and can be updated
normally.
